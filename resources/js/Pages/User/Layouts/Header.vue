            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div v-if="auth.user"
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <Link :href="route('admin.dashboard')" v-if="auth.user.isAdmin"
                        ...
                        <li>
                            <Link :href="auth.user.isAdmin ? route('admin.logout') : route('logout')" method="post" as="button"
                                  class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                Sign
                                out
                            </Link>
...
onMounted(() => {
    displayAllNotifications(usePage())
})
...
const cartItemsCount = computed(() => {
    return usePage().props.cartItemsCount
})
const search_input = ref('')

const search = async () => {
    try {
        await router.get(route('products.list'), {
